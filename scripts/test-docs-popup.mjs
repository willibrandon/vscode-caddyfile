...
const packagedGrammar = "syntaxes/caddyfile.tmLanguage.json";
assert(
  contributedGrammars.get("caddyfile") === packagedGrammar,
  "The caddyfile language does not contribute the expected packaged grammar",
);
assert(
